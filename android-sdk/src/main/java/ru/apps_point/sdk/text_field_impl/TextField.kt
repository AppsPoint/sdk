...
package ru.apps_point.sdk.text_field_impl
    ...
    Layout(
        ...
        content = {
            if (leading != null) {
                Box(
                    modifier = Modifier
                        .padding(start = if (iconHorizontalPadding != Dp.Unspecified) iconHorizontalPadding else HorizontalIconPadding)
                        .layoutId(LeadingId),
            ...
            if (trailing != null) {
                Box(
                    modifier = Modifier
                        .padding(end = if (iconHorizontalPadding != Dp.Unspecified) iconHorizontalPadding else HorizontalIconPadding)
                        .layoutId(TrailingId),
                    contentAlignment = Alignment.Center
                ) {
                    trailing()
